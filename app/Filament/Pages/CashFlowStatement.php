...
class CashFlowStatement extends Page
{
    ...
    protected string $view = 'filament.pages.cash-flow-statement';
    ...
    public function runReport(): void
    {
        ...
        $this->report = app(CashFlowStatementService::class)->report(
    ...
    {
        if (! Route::has('cash-flow-statement.print')) {
            return '#';
        }

        return route('cash-flow-statement.print', array_filter([
    ...
    public static function canAccess(): bool
    {
        ...
        return $user && $user->hasPermission('cash_flow_statement.view');
    }
}
