...
<head>
    ...
    <title>التقرير التفصيلي لفواتير المبيعات</title>
...
<main class="report">
    ...
    <div class="compact-header">
        ...
        <div class="compact-title">
            <h1>التقرير التفصيلي لفواتير المبيعات</h1>
        ...
        <section class="invoice-block">
            ...
            <table>
                ...
                <tr>
                    ...
                    <th style="width:14%">إجمالي السطر</th>
                </tr>
                </thead>
            ...
            <div class="invoice-totals">
                ...
                <div class="total-row">
                    ...
                    <div class="total-value">
                        {{ number_format(
                            (float) (
                                $invoice->service_tax_discount_amount ?? 0
                            ),
                            2
                        ) }}
                    </div>
                ...
                <div class="total-row">
                    ...
                    <div class="total-value">
                        {{ number_format(
                            (float) (
                                $invoice->one_percent_discount_amount ?? 0
                            ),
                            2
                        ) }}
                    </div>
