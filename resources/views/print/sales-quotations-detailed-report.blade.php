...
<head>
    <meta charset="UTF-8">
    <title>التقرير التفصيلي لعروض الأسعار</title>
...
<main class="report">
    ...
    <div class="compact-header">
        ...
        <div class="compact-title">
            <h1>التقرير التفصيلي لعروض الأسعار</h1>
        ...
        <section class="quotation-block">
            ...
            <div class="quotation-head">
                ...
                <div class="quotation-info">
                    ...
                    <div>
                        <span class="info-label">مسؤول المبيعات:</span>
                        <span class="info-value">
                    ...
                    <div>
                        <span class="info-label">حالة التحويل:</span>
                        <span class="info-value">
                            {{ $conversionLabel }}
                        </span>
                    </div>
            ...
            <table>
                ...
                <tr>
                    ...
                    <th style="width:11%">سعر الوحدة</th>
                    <th style="width:10%">الخصم</th>
                    <th style="width:10%">الضريبة</th>
                    <th style="width:13%">إجمالي السطر</th>
                </tr>
                </thead>
